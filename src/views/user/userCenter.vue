...
<div class="headInfo">
    ...
    <div class="info">
        <div class=""><span class="name">{{ userInfo?.nickname }}</span> <el-link class="email">{{ userInfo?.email }}</el-link></div>
...
.gradient-bg {
  ...
  background-size: 300% 300%; /* 扩大背景尺寸以实现渐变移动 */
  animation: gradientShift 8s ease infinite; /* 循环动画 */
}
